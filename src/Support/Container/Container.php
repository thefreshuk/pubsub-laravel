...
namespace TheFresh\PubSub\Support\Container;

use ArrayAccess;
use Closure;
use Exception;
use TheFresh\PubSub\Support\Container\ExceptionBindingResolutionException;
use TheFresh\PubSub\Support\Container\ExceptionCircularDependencyException;
use TheFresh\PubSub\Support\Container\Interface\Container as ContainerContract;
use LogicException;
use ReflectionClass;
